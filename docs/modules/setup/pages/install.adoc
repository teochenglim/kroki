...
[shell]
....
cd docs/modules/setup/examples/
docker-compose -f kroki-docker-compose.yml up
...
[shell]
....
docker-compose -f kroki-docker-compose.yml down
....
...
==== To test the installation is successful
