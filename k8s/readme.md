### install kroki on kubernetes

##### purposely left out ingress to reduce the complexity

```shell
### apply the service, from git root directory
$ kubectl apply -f k8s/

### port-forward to check the service is running fine
...
<svg viewBox="0 0 640 489" xmlns="http://www.w3.org/2000/svg" xmlns:inkspace="http://www.inkscape.org/namespaces/inkscape" xmlns:xlink="http://www.w3.org/1999/xlink" width="640px" height="489px">
  <defs id="defs_block">
